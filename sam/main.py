...
from sam.loaders.loaders import Loaders
from sam.prompts.prompts import create_prompt_icl_qa
from sam.vectorstore.vectorstores import VectoreStores
...
async def vector_load():
    path = fr'D:\AI\chat-your-data\state_of_union.txt'
    embeddings = EmbeddingLoader("cohere").load_embeddings()
